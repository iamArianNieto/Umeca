...
Module ConexionSistemaUsuario
    Public conn As New SqlConnection("Data Source=10.18.8.195; Initial Catalog=GESTION_USUARIOS; User ID=Agenda; Password=Ag3nd4egm")
